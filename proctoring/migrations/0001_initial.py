    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(to='proctoring.Course', on_delete=models.CASCADE)),
                ('proctor', models.ForeignKey(to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Exam',
            fields=[
                ...
                ('course', models.ForeignKey(to='proctoring.Course', on_delete=models.CASCADE)),
                ('event', models.ForeignKey(blank=True, to='proctoring.EventSession', null=True, on_delete=models.CASCADE)),
                ('proctor', models.ForeignKey(blank=True, to=settings.AUTH_USER_MODEL, null=True, on_delete=models.CASCADE)),
                ('student', models.ForeignKey(to='person.Student', on_delete=models.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='comment',
            name='exam',
            field=models.ForeignKey(to='proctoring.Exam', on_delete=models.CASCADE),
        ),
        migrations.CreateModel(
